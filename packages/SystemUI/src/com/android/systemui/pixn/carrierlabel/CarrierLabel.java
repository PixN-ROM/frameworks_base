...
package com.android.systemui.pixn.carrierlabel;
...
import com.android.internal.util.pixn.PixNUtils;
...
import com.android.systemui.pixn.carrierlabel.SpnOverride;
    ...
    private final BroadcastReceiver mIntentReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (TelephonyIntents.SPN_STRINGS_UPDATED_ACTION.equals(action)
                ...
                isCN = PixNUtils.isChineseLanguage();
            }
        }
    };
